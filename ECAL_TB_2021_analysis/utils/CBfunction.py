...
class CBfunction:
    ...
    def set_selection(self):
        ...
        self.selection = f' amp_max[C2] > {self.Amin} && amp_max[C2]< {self.Amax} && fit_ampl[MCP1]>120 && fabs(h1X.clusters.X_- {self.xcenter}) && fabs(h1Y.clusters.Y_- {self.ycenter})'
    ...
    def CBintialization(self):
        ...
        self.s = RooRealVar("sigma_%s_%s"%(self.crystal,self.energy),"sigma_%s_%s"%(self.crystal,self.energy),self.s_initial,10,500) #500.
        self.a = RooRealVar("alpha_%s_%s"%(self.crystal,self.energy),"alpha_%s_%s"%(self.crystal,self.energy),self.a_initial,-10.,10)
        self.n = RooRealVar("exp_%s_%s"%(self.crystal,self.energy),"exp_%s_%s"%(self.crystal,self.energy),self.n_initial,0.,500)
    ...
    def CB2intialization(self):
        ...
        self.n = RooRealVar("exp_%s_%s"%(self.crystal,self.energy),"exp_%s_%s"%(self.crystal,self.energy),self.n_initial,0.,100)
    ...
    def plot(self):
        ...
        txt_chi2 = ROOT.TText(self.peak_position*(1.0-2*self.xaxis_scale),self.ymax_value*0.95,"Chi2 = %.1f"%self.chi2)
