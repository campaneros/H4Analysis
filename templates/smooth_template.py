...
parser.add_argument('--path' , default = '/eos/home-c/camendol/ECALTB/ECAL_TB_Oct2021/ntuples/ECAL_H4_Oct2021/ntuples_c2escan_v2//')
parser.add_argument('--fname' , default = 'corrected_template')
parser.add_argument('--hname' , default = 'tmpl')
